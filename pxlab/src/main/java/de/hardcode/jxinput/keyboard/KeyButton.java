...
/**
 * Associates a keycode with a Button and handles the current state of that
 * button.
 * 
 * @author Herkules
 */
class KeyButton implements Button {
	...
	/**
	 * Retrieve the type of the button. Pushbutton will deliver
	 * <code>true==getState()</code> as long as they are pressed down.
	 * Togglebuttons will change their state once they are pressed and keep that
	 * state until they are pressed again.
	 * 
