...
/**
 * Manages the available instances of JXInputDevice. It holds the one central
 * update method which synchronizes with the physical device.
 * 
 * @author Herkules
 */
public class JXInputManager {
	...
	/**
	 * Creates a new instance of JXInputManager. This is prohibited - it only
	 * has static members.
	 */
	...
	/**
	 * Master reset for all devices and events. After calling reset(), better
	 * forget all devices created or retrieved. They are no longer valid. Event
	 * listeners will no longer be called and should be discarded.
	 */
	...
	/**
	 * Update the (shared) state of all features in one step. This method asks
	 * the actual device for a consistant state. After calling this method, all
	 * features may have new values. updateFeatures() is meant to be called e.g.
	 * once per frame in a gaming environment.
	 */
	...
	/**
	 * Create a new pseudo-device listening to a Swing component. Make sure that
	 * the component also has the keyboard focus!!
	 */
	...
	/**
	 * Delete a keyboard device again e.g. when the corresponding JComponent
	 * gets deleted.
	 */
