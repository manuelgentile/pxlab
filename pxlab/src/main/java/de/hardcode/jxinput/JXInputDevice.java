 ...
 * <p>
 * The basis task of a <code>JXInputDevise</code> is to maintain a consistent
 * state of all its features. <br>
 * It is save to distribute the <code>Feature</code> objects into application
 * without worrying about someone else performing an <code>update</code> method
 * and thereby destructing the consistent state.
 * <p>
 * An additional task is to provide basic device features information like
 * number of axes, buttons and directional features.
 * 
 * @see Feature
 * @see JXInputManager
 * 
...
public interface JXInputDevice {
	...
	/* #Feature lnkFeature; */
	/**
	 * Devices may have a name. This name might be provided by a system
	 * dependant driver.
	 */
	String getName();
