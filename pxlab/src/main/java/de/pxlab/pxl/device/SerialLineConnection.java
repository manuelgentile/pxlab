 ...
 */
public class SerialLineConnection implements SerialPortEventListener {
	private SerialLineReceiver receiver;
	private SerialLineParameters parameters;
	 ...
	 * 
	 * @param parameters
	 *            A SerialLineParameters object.
	 * @param receiver
	 *            the destination of strings received by this port.
	 */
	public SerialLineConnection(SerialLineParameters parameters,
			SerialLineReceiver receiver) {
	 ...
	 */
	public void openConnection() throws SerialLineException {
		// System.out.println("SerialLineConnection.openConnection()");
		// Obtain a CommPortIdentifier object for the port you want to open.
		try {
			String n = parameters.getPortName();
			portId = CommPortIdentifier.getPortIdentifier(n);
		...
		// System.out.println("Port " + portId.getName() + " open.");
		// Set the parameters of the connection. If they won't set, close the
		// port before throwing an exception.
		try {
			setConnectionParameters();
		} catch (SerialLineException e) {
			sPort.close();
			throw e;
		}
		...
		try {
			...
			sPort.close();
			throw new SerialLineException("Error opening i/o streams");
		}
		...
		try {
			...
			sPort.close();
			throw new SerialLineException("too many listeners added");
		}
	 ...
	 * exception.
	 */
	public void setConnectionParameters() throws SerialLineException {
		...
		try {
			...
			throw new SerialLineException("Unsupported parameter");
		}
		// Set flow control.
		try {
			...
			throw new SerialLineException("Unsupported flow control");
		}
	}
	...
	public void serialEvent(SerialPortEvent e) {
		...
		case SerialPortEvent.DATA_AVAILABLE:
			...
			// System.out.println("Received: " + inputBuffer);
			break;
