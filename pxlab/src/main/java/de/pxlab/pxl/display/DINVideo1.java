 ...
 * 05/18/00
 */
public class DINVideo1 extends Display {
	...
	public ExPar Color4 = new ExPar(COLOR, new ExParValue(new YxyColor(29.15,
			0.289, 0.416)), "Color5");
	public ExPar Color5 = new ExPar(COLOR, new ExParValue(new YxyColor(31.13,
			0.26, 0.321)), "Color6");
	public ExPar Color6 = new ExPar(COLOR, new ExParValue(new YxyColor(29.9,
			0.243, 0.258)), "Color7");
	public ExPar Color7 = new ExPar(COLOR, new ExParValue(new YxyColor(29.95,
			0.291, 0.259)), "Color8");
	public ExPar Color8 = new ExPar(COLOR, new ExParValue(new YxyColor(31.44,
			0.333, 0.276)), "Color9");
	public ExPar Color9 = new ExPar(COLOR, new ExParValue(new YxyColor(11.18,
			0.567, 0.312)), "Color10");
	public ExPar Color10 = new ExPar(COLOR, new ExParValue(new YxyColor(58.78,
			0.434, 0.471)), "Color11");
	public ExPar Color11 = new ExPar(COLOR, new ExParValue(new YxyColor(19.83,
			0.253, 0.422)), "Color12");
	public ExPar Color12 = new ExPar(COLOR, new ExParValue(new YxyColor(6.75,
			0.172, 0.160)), "Color13");
	public ExPar Color13 = new ExPar(COLOR, new ExParValue(new YxyColor(57.5,
			0.373, 0.363)), "Color14");
	public ExPar Color14 = new ExPar(COLOR, new ExParValue(new YxyColor(11.76,
			0.356, 0.448)), "Color15");
	public ExPar Color15 = new ExPar(COLOR, new ExParValue(new YxyColor(3.69,
			0.316, 0.337)), "Color16");
	public ExPar Color16 = new ExPar(COLOR, new ExParValue(new YxyColor(19.58,
			0.310, 0.328)), "Color17");
	public ExPar Color17 = new ExPar(COLOR, new ExParValue(new YxyColor(75.78,
			0.313, 0.327)), "Color18");

	public DINVideo1() {
		setTitleAndTopic("DIN 6169 Video: Display Test Colors 1",
	...
	protected void computeGeometry() {
		...
		int hb = 5;
		int k = 2;
		int n = (rows * columns) - 3;
		Rectangle r = centeredRect(width, height, (int) (2 * width / 3),
				(int) (3 * height / 4));
