...
/**
 * A display pattern for finding the red gamma function of your monitor by
 * visual adjustment.
 * 
 * <P>
 ...
 * @version 0.2.0
 */
public class VisualGammaRed extends VisualGammaFields {
	public VisualGammaRed() {
		setTitleAndTopic("Visual gamma function measurement: red",
				VISUAL_GAMMA_DSP | DEMO);
		PrimaryColor.set(new PxlColor(Color.red));
		channel = 0;
		initColorPars();
	}
}
