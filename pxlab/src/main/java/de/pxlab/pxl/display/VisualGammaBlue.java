...
/**
 * A display pattern for finding the blue gamma function of your monitor by
 * visual adjustment.
 * 
 * <P>
 ...
 * @version 0.2.0
 */
public class VisualGammaBlue extends VisualGammaFields {
	public VisualGammaBlue() {
		setTitleAndTopic("Visual gamma function measurement: blue",
				VISUAL_GAMMA_DSP | DEMO);
		PrimaryColor.set(new PxlColor(Color.blue));
		channel = 2;
		initColorPars();
	}
}
