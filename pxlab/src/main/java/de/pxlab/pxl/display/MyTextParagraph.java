...
// import java.awt.*;
import de.pxlab.pxl.AlignmentCodes;
import de.pxlab.pxl.ExPar;
import de.pxlab.pxl.ExParExpression;
import de.pxlab.pxl.ExParValue;
import de.pxlab.pxl.ExParValueConstant;
import de.pxlab.pxl.MyTextParagraphElement;
import de.pxlab.pxl.TextParagraphElement;
 ...
 */
public class MyTextParagraph extends TextDisplay {
	...
	protected MyTextParagraphElement textpar;

	/** Initialize the display list of the demo. */
	protected int create() {
		textpar = new MyTextParagraphElement(this.Color);
