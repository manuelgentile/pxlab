 ...
 */
public class JChart extends JComponent implements MouseListener,
	 ...
	 */
	public JChart(AxisModel xm, int nxt, AxisModel ym, int nyt, double y2xr) {
	...
	public void setPreferredHorizontalSpacing(int leftBorder, int gridWidth,
		...
		// System.out.println("JChart.setPreferredHorizontalSpacing(): " +
		// leftBorder + " " + preferredGridWidth + " " + rightBorder);
	}
	...
	public void setPreferredVerticalSpacing(int topBorder, int gridHeight,
		...
		// System.out.println("JChart.setPreferredVerticalSpacing(): " +
		// topBorder + " " + preferredGridHeight + " " + bottomBorder);
	}

	/** Return the preferred size of the chart. */
	public Dimension getPreferredSize() {
		Dimension s = new Dimension(leftBorder + preferredGridWidth
				+ rightBorder, topBorder + preferredGridHeight + bottomBorder);
		// System.out.println("JChart.getPreferredSize(): " + s);
		return s;
	}
	 ...
	 * 
	 * public void update(Graphics g) { if (backBuffer == null) { backBuffer =
	 * new BackBuffer(this); } Graphics b = backBuffer.getGraphics();
	 * super.update(b); paint(b); backBuffer.blit(g); }
	 */
	/**
