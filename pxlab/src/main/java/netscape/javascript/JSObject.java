 ...
 * <li>Any other Java object is converted to a JavaScript wrapper, which can be
 * used to access methods and fields of the java object. Converting this wrapper
 * to a string will call the toString method on the original object, converting
 * to a number will call the doubleValue method if possible and fail otherwise.
 * Converting to a boolean will try to call the booleanValue method in the same
 * way.
 ...
 * <li>Java byte, char, short, int, long, float, and double are converted to
 * JavaScript numbers
 * </ul>
 ...
 * <li>strings, numbers and booleans are converted to String, Double, and
 * Boolean objects respectively
 * </ul>
 * This means that all JavaScript values show up as some kind of
 * java.lang.Object in Java. In order to make much use of them, you will have to
 * cast them to the appropriate subclass of Object, e.g.
 * <code>(String) window.getMember("name");</code> or
...
public final class JSObject {
	 ...
	 * "this.<i>methodName</i>(<i>args</i>[0], <i>args</i>[1], ...)" in
	 * JavaScript.
	 */
	...
	/**
	 * Override java.lang.Object.equals() because identity is not preserved with
